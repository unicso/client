<template>
  <section>
    ...
    <div class="input__field">
      ...
      <ul>
        <li v-for="(items, name) in FETCH_DATA_ITEMS()">
          <label v-if="2==3"><input type="checkbox" ><b>{{name}}</b></label>
    ...
    <div class="client_support content_block">
      ...
      <main>
        ...
        <div class="field__block">
          ...
          <input type="text"  v-model="$store.state.helper.smart_request.location">
        </div>
        <div class="field__block">
    ...
    FETCH_DATA_ITEMS()
    {
        var data = {
          'Системы пожаротушения':[
              'Проектные работы по системе пожаротушения',
              'Водяное пожаротушение',
              'Порошковое пожаротушение',
              'Газовое пожаротушение',
              'Внутренний пожарный водопровод'
          ],
        'Системы дымоудаления, вентиляции':[
            'Монтаж противодымной вентиляции',
            'Монтаж систем вентиляции и кондиционирования'
            ],
          'Системы АПС и СОУЭ':[
                'СОУЭ Звуковое оповещение',
                'СОУЭ Речевое оповещение',
                'АПС Радиоканальная',
                'АПС Адресная',
                'АПС Безадресно-пороговая'
          ...
          'Инженерные системы':[
                'Монтаж систем электроснабжения, освещения, кабельных сетей, телефонизации'
              ],
          'Охранные системы, видеонаблюдение':[
                'Проектные работы по охранной системе',
                'Монтаж охранной сигнализации',
                'Монтаж систем видеонаблюдения',
                'Монтаж систем контроля и управления доступом',
                'Расчет и разработка нормативно-технической документации в области пожарной безопасности',
                'Техническое обслуживание систем пожарной безопасности зданий и сооружений'
